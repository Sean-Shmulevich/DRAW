...
### Code Improvements
- Fixed image import persistence by drawing images to permanent layer instead of main canvas
- Fixed shape fill color disappearing after undo by ensuring RGB color mode before redrawing
- Added `html2canvas` dependency for screenshot functionality
- Improved color mode management across drawing functions
